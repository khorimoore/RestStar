...
//----------------------------------------------------------------
// Function to send a POST request to the '/auth/signup' endpoint with user registration information
const signup = async (userInfo: UserLogin) => {
  try {
    // Send a POST request to '/auth/signup' with user registration information in JSON format
